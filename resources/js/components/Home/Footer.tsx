...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { label: 'Parcours certifiants', href: '/paths' },
    { label: 'Mentors', href: '/mentors' },
    { label: 'Offres d\'emploi', href: '/jobs' },
    { label: 'Entreprises partenaires', href: '/partners' }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <form className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <button
                type="submit"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mb-8">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 flex items-center justify-center bg-gray-900 hover:bg-gray-800 text-gray-400 hover:text-white rounded-xl transition-colors duration-300"
            ...
            <div className="space-y-3">
              <p className="text-white font-semibold">Téléchargez notre app</p>
              <div className="flex gap-3">
                <button className="flex items-center gap-2 px-4 py-3 bg-gray-900 hover:bg-gray-800 rounded-xl transition-colors duration-300">
