  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <main className="flex-1">
        ...
        {/* Hero Section - REDIMENSIONNÉE */}
        <section className="relative py-12 md:py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900">
          {/* Particules animées */}
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 animate-fade-in" style={{ animationDelay: '600ms' }}>
              {!auth.user ? (
                <>
                  <Link
                    href="/register"
                    className="group relative bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden"
                  >
                ...
                <Link
                  href="/dashboard"
                  className="group bg-white text-gray-900 px-8 sm:px-10 py-4 sm:py-5 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  <span className="relative flex items-center justify-center gap-2">
        ...
        {/* Parcours d'apprentissage - REDIMENSIONNÉ */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {learningPaths.map((path, i) => (
                <div
                  key={i}
                  className="group bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-indigo-500 transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg"
                >
                  ...
                  <Link
                    href={`/paths/${path.title.toLowerCase().replace(/ /g, '-')}`}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-gray-50 dark:bg-gray-800 p-5 sm:p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-indigo-500 transition-all duration-300"
                >
        ...
        {/* CTA Final - REDIMENSIONNÉ */}
        <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600">
          <div className="absolute inset-0">
            <img
